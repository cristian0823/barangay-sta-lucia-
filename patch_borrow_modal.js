...
html = html.replace('id="borrowModalImage" src="../BARANGAY SUN LOGO.jpg" alt="Equipment" class="w-full h-full object-cover', 'id="borrowModalImage" src="../BARANGAY SUN LOGO.jpg" alt="Equipment" class="w-full h-full object-contain');
