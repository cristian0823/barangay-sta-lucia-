...
html = html.replace('id="borrowModalImage" src="../BARANGAY%20SUN%20LOGO.jpg" alt="Equipment" class="w-full h-full object-cover', 'id="borrowModalImage" src="../BARANGAY%20SUN%20LOGO.jpg" alt="Equipment" class="w-full h-full object-contain');
