...
const regex1 = /<div class="flex justify-end mb-6">[\s\S]*?<\/button>\s*<\/div>/;
...
html = html.replace(regex1, newHtml);

const regex2 = /<div id="unifiedHistoryList" class="grid grid-cols-1 md:grid-cols-2 gap-5">\s*<\/div>/;
const newHtml2 = `<div id="unifiedHistoryList" class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
