...
const oldBorrow = "const imageName = item.name ? '../' + item.name.toLowerCase().replace(/s$/, '') + '.jpg' : '../BARANGAY LOGO.jpg';\n            document.getElementById('borrowModalImage').src = imageName;";
const newBorrow = "const imageSrc = item.image_url ? item.image_url : '../BARANGAY LOGO.jpg';\n            document.getElementById('borrowModalImage').src = imageSrc;";
