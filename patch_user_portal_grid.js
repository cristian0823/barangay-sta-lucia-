...
html = html.replace(
    `const imageName = item.name ? '../' + item.name.toLowerCase().replace(/s$/, '') + '.jpg' : '../BARANGAY%20SUN%20LOGO.jpg';
                ...
                return \`<div class="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
                    ...
                    <div class="relative h-48 w-full bg-gray-100 dark:bg-gray-700 overflow-hidden shrink-0">
                        <img src="\${imageName}" alt="\${item.name}" class="w-full h-full object-contain object-center bg-white dark:bg-gray-800 transition-transform duration-500 group-hover:scale-110" onerror="this.src='../BARANGAY%20SUN%20LOGO.jpg'; this.onerror=null;">`,
    `const imageSrc = item.image_url ? item.image_url : '../BARANGAY%20SUN%20LOGO.jpg';

                return \`<div class="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
                    <!-- Image Header -->
                    <div class="relative h-48 w-full bg-gray-100 dark:bg-gray-700 overflow-hidden shrink-0">
                        <img src="\${imageSrc}" alt="\${item.name}" class="w-full h-full object-cover object-center bg-white dark:bg-gray-800 transition-transform duration-500 group-hover:scale-110" onerror="this.src='../BARANGAY%20SUN%20LOGO.jpg'; this.onerror=null;">`
);
